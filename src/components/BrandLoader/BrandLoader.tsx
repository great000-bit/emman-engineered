...
const BrandMark = ({ reduceMotion }: { reduceMotion: boolean }) => (
  ...
  >
    <motion.path
      ...
      transition={{ delay: reduceMotion ? 0 : 0.08, duration: reduceMotion ? 0.01 : 0.35, ease: [0.16, 1, 0.3, 1] }}
    ...
    <motion.path
      ...
      transition={{ delay: reduceMotion ? 0 : 0.25, duration: reduceMotion ? 0.01 : 0.3, ease: [0.16, 1, 0.3, 1] }}
    ...
    <motion.path
      ...
      initial={reduceMotion ? false : { opacity: 0, x: 3, y: 2, scale: 0.78 }}
      animate={{ opacity: 1, x: 0, y: 0, scale: 1 }}
      transition={{ delay: reduceMotion ? 0 : 0.4, duration: reduceMotion ? 0.01 : 0.3, ease: [0.16, 1, 0.3, 1] }}
    ...
    >
      ...
      >
        ...
        <motion.div
          ...
          transition={{
            delay: reduceMotion ? 0.3 : 0.7,
            duration: reduceMotion ? 1.55 : 1.3,
            times: [0, 0.36, 0.64, 1],
            ease: [0.16, 1, 0.3, 1],
          }}
        >
