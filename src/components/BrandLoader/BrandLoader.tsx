...
const BrandLoader = () => {
  const [visible, setVisible] = useState(() => {
    if (window.location.pathname !== "/" || (window as any).__brandLoaderShown) {
      // Bypassed: Clean up bootstrap elements and classes immediately.
      removeBootstrap();
    ...
    (window as any).__brandLoaderShown = true;
    return true;
  });
